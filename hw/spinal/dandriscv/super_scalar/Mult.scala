...
case class mult() extends BlackBox {
  ...
  val i_x = in UInt(64 bits)
  val i_y = in UInt(64 bits)
  val o_hi_res = out UInt(64 bits)
  val o_lw_res  = out UInt(64 bits)
...
case class Multiplier() extends Component {
  val io = new Bundle {
    ...
    val src1 = in UInt(64 bits)
    val src2 = in UInt(64 bits)
    val result_high = out UInt(64 bits)
